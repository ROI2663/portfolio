...
export const services: ServiceItem[] = [
  {
    title: "手書きアンケート・紙書類のデータ化＋集計代行",
    description:
      "アンケート用紙の写真やスキャンを送るだけ。AIが手書きを一枚ずつ正確に読み取り、Excel化から満足度などの集計まで仕上げてお返しします。入力作業をまるごとなくせます。",
    icon: "Workflow",
    price: "1枚150円・最低5,000円（集計込み）｜まず10枚無料",
  },
  {
    title: "レシート・領収書のAI自動データ化",
    description:
      "レシート・領収書・請求書を撮って送るだけ。日付・取引先・金額・勘定科目を読み取り、スプレッドシートへ自動で記帳・仕分けします。",
    icon: "Workflow",
    price: "5万円〜（まずは無料サンプル）",
  },
  {
...
export const caseStudies: CaseStudy[] = [
  {
    title: "アンケートの入力・集計の手間をなくしたい",
    challenge: "研修・セミナー後の手書きアンケートの入力と集計に、毎回時間を取られている。",
    support:
      "写真を送るだけで、AIが読み取りからExcel化・満足度集計まで仕上げてお返しします。",
  },
  {
    title: "経費入力の手間を減らしたい",
...
export const galleryItems: GalleryItem[] = [
  {
    title: "手書きアンケート AI-OCRデータ化",
    category: "デモ作品 / データ化代行【主力】",
    description:
      "手書きの研修アンケートを撮影した画像から、AIが評価・自由記述まで一枚ずつ読み取り、Excelの一覧と満足度集計に自動変換するデモです。",
    image: "/images/work-survey.png",
    video: "/videos/survey-ocr-demo.mp4",
  },
  {
...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "手書きアンケートのデータ化は1枚150円（最低5,000円・集計込み）、レシートのデータ化や業務自動化の仕組みは5万円〜、AIチャットボットは10万円〜が目安です（内容により相談）。まずはアンケート10枚まで無料でお試しいただけます。",
  },
  {
    question: "依頼前に品質を確認できますか？",
    answer:
      "はい。実際に動くデモを公開しており、現物で品質をご確認いただけます。さらに、ご依頼前にアンケート10枚（またはレシート数枚）を無料でデータ化してお返ししますので、精度と仕上がりを見てからご判断いただけます。",
  },
  {
...
export const profile = {
  ...
  heading: "紙・手書き書類のデータ化を、「送るだけ」で仕上げます",
  career:
    "2026年6月より、個人でAIを活用した業務効率化に取り組んでいます。会社員として日々の実務にAIを取り入れ、データ入力や資料作成を効率化してきた経験を活かし、手書きアンケートやレシートなど紙書類のデータ化・業務自動化の仕組みを自作・運用しています。業種を問わず『地味で時間のかかる作業』を仕組みでなくします。",
  skills: [
...
export const contactHearing = {
  title: "初回ヒアリング無料",
  description:
    "手書きアンケートやレシートのデータ化、業務自動化、AIチャットボットなど、業務のお困りごとをお気軽にお聞かせください。まずはアンケート10枚まで無料でデータ化してお返しし、現状に合わせて最適なご提案をします。",
  highlights: [
    "まずはアンケート10枚まで無料でデータ化",
    "原則当日〜翌営業日にご返信",
    "秘密厳守・NDA対応可",
    "オンライン対応・全国OK",
  ],
